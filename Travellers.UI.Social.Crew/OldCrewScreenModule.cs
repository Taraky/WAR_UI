...
public class OldCrewScreenModule : CharacterSheetModule
{
	...
	public override CharacterSheetTabType DefaultTabType => CharacterSheetTabType.OldCrew;

	protected override TutorialHookType tutorialHookType => TutorialHookType.Inventory_CrewTab;

	public OldCrewScreenModule(Transform screenParent, Transform tabParent, HorizontalOrVerticalLayoutGroup layoutParent, Action<CharacterSheetTabType> onTabPressed, UIToggleGroup toggleGroup)
	...
	{
		return UIObjectFactory.Create<OldCrewScreen>(UIElementType.ScreenComponent, UIFillType.KeepOriginalAnchoring, screenParent, isObjectActive: false);
	}
}
