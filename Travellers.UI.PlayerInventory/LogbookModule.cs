...
public class LogbookModule : CharacterSheetModule
{
	...
	protected override string tabName => "LOG BOOK";

	protected override HashSet<CharacterSheetTabType> showTabForTheseContexts => _showTabForTheseContexts;

	public override CharacterSheetTabType DefaultTabType => CharacterSheetTabType.Logbook;

	protected override TutorialHookType tutorialHookType => TutorialHookType.Inventory_LogbookTab;

	public LogbookModule(Transform screenParent, Transform tabParent, HorizontalOrVerticalLayoutGroup layoutParent, Action<CharacterSheetTabType> onTabPressed, UIToggleGroup toggleGroup)
	...
	{
		return UIObjectFactory.Create<LogbookUI>(UIElementType.ScreenComponent, UIFillType.KeepOriginalAnchoring, screenParent, isObjectActive: false);
	}
}
